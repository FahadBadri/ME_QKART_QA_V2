...
public class QkartSanityV2 {
    ...
    public static Boolean TestCase11(RemoteWebDriver driver) throws InterruptedException {
        ...
        logStatus("Start TestCase", "TestCase11: Check for advertisements", "DONE");

        Register registration = new Register(driver);
        registration.navigateToRegisterPage();
        status = registration.registerUser("testUser", "abc@123", true);
        if (!status) {
            logStatus("TestCase11", "Test Case Failure.Check for advertisements", "FAIL");
        }
        ...
        logStatus("End TestCase", "TestCase11:Check for advertisements Test Completed : ",
                status ? "PASS" : "FAIL");
