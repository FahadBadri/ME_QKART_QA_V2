...
public class Home {
    ...
    public Boolean searchForProduct(String product) {
        try {
            ...
            WebDriverWait wait = new WebDriverWait(driver,30);
            //wait.until(ExpectedConditions.visibilityOfElementLocated(By.className("MuiTypography-root MuiTypography-body1 css-yg30e6")));
            wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id=\"root\"]/div/div/div[3]/div/div[2]/div/div/div[1]/p[1]")));
            Thread.sleep(3000);
            return true;
        } catch (Exception e) {
