...
public class SearchResult {
    ...
    public Boolean validateSizeChartContents(List<String> expectedTableHeaders,
        ...
        try {
            ...
            List<WebElement> actualTableHeaderElements =
                    driver.findElements(By.xpath("//table//thead//tr//th"));
            for (int i = 0; i < expectedTableHeaders.size(); i++) {
                String expectedTableHeader = expectedTableHeaders.get(i);
                WebElement actualTableHeaderElement = actualTableHeaderElements.get(i);
            ...
            for (int i = 0; i < expectedTableBody.size(); i++) {
                ...
                //System.out.println(expectedTableBodyText);
                int row =i+1;
                int column = j+1;
                WebElement actualTableElement=driver.findElement(By.xpath("//table/tbody/tr["+row+"]/td["+column+"] "));
                String    actualTableBodyText= actualTableElement.getText();
